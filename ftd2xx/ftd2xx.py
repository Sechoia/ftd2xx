...
class ProgramData(TypedDict, total=False):
    ...
    PullDownEnableH: Union[_ft.UCHAR, int]
    SerNumEnableH: Union[_ft.UCHAR, int]
    ACSlowSlewH: Union[_ft.UCHAR, int]
    ACSchmittInputH: Union[_ft.UCHAR, int]
    ACDriveCurrentH: Union[_ft.UCHAR, int]
    ADSlowSlewH: Union[_ft.UCHAR, int]
    ADSchmittInputH: Union[_ft.UCHAR, int]
    ADDriveCurrentH: Union[_ft.UCHAR, int]
    Cbus0H: Union[_ft.UCHAR, int]
    Cbus1H: Union[_ft.UCHAR, int]
    Cbus2H: Union[_ft.UCHAR, int]
    Cbus3H: Union[_ft.UCHAR, int]
    Cbus4H: Union[_ft.UCHAR, int]
    Cbus5H: Union[_ft.UCHAR, int]
    Cbus6H: Union[_ft.UCHAR, int]
    Cbus7H: Union[_ft.UCHAR, int]
    Cbus8H: Union[_ft.UCHAR, int]
    Cbus9H: Union[_ft.UCHAR, int]
    IsFifoH: Union[_ft.UCHAR, int]
    IsFifoTarH: Union[_ft.UCHAR, int]
    IsFastSerH: Union[_ft.UCHAR, int]
    IsFT1248H: Union[_ft.UCHAR, int]
    FT1248CpolH: Union[_ft.UCHAR, int]
    FT1248LsbH: Union[_ft.UCHAR, int]
    FT1248FlowControlH: Union[_ft.UCHAR, int]
    IsVCPH: Union[_ft.UCHAR, int]
    PowerSaveEnableH: Union[_ft.UCHAR, int]
